...
namespace TaskFlow.Api.Services.Interfaces
{
    public interface ICategoryService
    {
        ...
        // Thêm int userId vào tất cả các hàm
        Task<IEnumerable<CategoriesResponseDto>> GetAllAsync(int userId);

        Task<CategoriesResponseDto> GetByIdAsync(int id, int userId);

        Task<CategoriesResponseDto> CreateAsync(CreateCategoryRequestDto request, int userId);

        Task<bool> UpdateAsync(int id, UpdateCategoryRequestDto request, int userId);
